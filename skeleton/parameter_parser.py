...
def parameter_parser():
    ...
    """
    parser = argparse.ArgumentParser(description = "Run recommender system algorithms.")
    ...
    parser.add_argument("--lambda-1", type = float, default = 2e-1,
                        help = "hyperparameters for sparsity regularization for U in MF algorithm. Default is 1e-2")
    
    parser.add_argument("--lambda-2", type = float, default = 2e-1,
                        help = "hyperparameters for sparsity regularization for V in MF algorithm. Default is 1e-2")
    
    parser.add_argument("--max_iters", type = int, default = 2000,
                        help = "max_iters is maximum iteration count for the MC and MF algorithm. Defualt is 2000. ")
